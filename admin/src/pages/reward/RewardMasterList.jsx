                  ...
                  {rewardMasters.length === 0 ? (
                    ...
                    rewardMasters.map((rm) => (
                      <TableRow key={rm._id} hover>
                        <TableCell>{rm.reward_type}</TableCell>
                        ...
                        <TableCell>
                          <Switch checked={rm.active} disabled />
                        </TableCell>
                        <TableCell>
                          <IconButton onClick={() => handleOpenDialog(rm)} size="small">
                            <Edit fontSize="small" />
                          </IconButton>
                          <IconButton onClick={() => handleDelete(rm._id)} size="small" color="error">
